          ...
          <div id="servicesoptions">
            {services
              ...
              .map((service) => (
                ...
                >
                  <img
                    src="https://img.grouponcdn.com/bynder/2raSs4CzQsC9NxKzFpVFx3Fak1Dr/2r-2048x1229/v1/t600x362.jpg"
                    alt=""
                  />
              ...
              <div className="service-details">
                ...
                <div id="middleFetchedData">
                  {uniqueSubcategories.map((subcategory) => {
                    ...
                    return (
                      <div key={subcategory}>                        {subcategory === "null" ? (
                        <h2 id="HeadingForSubcateg" className="extra-class">
                          {subcategory}
                        </h2>
                      ) : (
