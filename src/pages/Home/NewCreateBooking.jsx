    ...
    const handleBooking = () => {
      ...
      if (existingData) {
       ...
       dataArray.forEach((item) => {
        ...
        const subserviceArr = allservicesarray.map(obj => ({ service_name:obj.service_name,qty:obj.quantity,price:obj.price_including_gst,gst:obj.gst,total:obj.price_including_gst,stylist_id:obj.stylist_info?obj.stylist_info:null,date:null, type: "service" }))
        if(productArr){
          console.log(productArr,"product");
